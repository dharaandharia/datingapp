...
<script type="text/javascript">
   ...
   const paymentForm = new SqPaymentForm({
     ...
     applicationId: "sandbox-sq0idb-jGQK_u2d4havXk4YWnao5g",
     inputClass: 'sq-input',
     autoBuild: false,
...
function setval1(rlink1,rlink2)
{
  alert(rlink1+'/'+rlink2);
  location.href='{{ url('process-payment')}}'+ '/'+rlink1+'/'+rlink2;
}
 </script>
 ...
 <div id="form-container">
    ...
    <form id="payment-form">
      ...
      <button id="card-button" type="button" onclick="setval1(<?php echo $amount; ?>,<?php echo $subscription; ?>)">Pay £{{ $amount }}</button>
